                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="artists-thumb">
                                <div class="artists-image-wrap">
                                    <img src="{{asset ('front/images/artists/joecalih-UmTZqmMvQcw-unsplash.jpg')}}" class="artists-image img-fluid">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="artists-thumb">
                                <div class="artists-image-wrap">
                                    <img src="{{asset ('front/images/artists/abstral-official-bdlMO9z5yco-unsplash.jpg')}}" class="artists-image img-fluid">
                                </div>
                            ...
                            <div class="artists-thumb">
                                <img src="{{asset ('front/images/artists/soundtrap-rAT6FJ6wltE-unsplash.jpg')}}" class="artists-image img-fluid">
